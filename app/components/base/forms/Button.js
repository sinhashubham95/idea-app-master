...
export default class Button extends PureComponent {
    ...
    render() {
        ...
        const textStyle = [{ color: 'white', letterSpacing: 2, fontSize: 15, fontFamily: 'ProximaNova-Bold' }, this.props.textStyle];

        return Platform.OS === 'android' && Platform.Version >= 21 ? (
            <View style={{ opacity: this.props.disabled ? 0.8 : 1 }}>
...
export const ButtonPrimary = props => <Button {...props} style={[{ backgroundColor: pallette.buttonPrimary }, props.style]} />;

export const ButtonSecondary = props => (
    <Button
      {...props}
      style={[{ backgroundColor: pallette.buttonSecondary }, props.style]}
    />
);
export const ButtonTertiary = props => <Button textStyle={{color: pallette.wazokuNavy}} {...props} style={[{ backgroundColor: 'white', borderColor: pallette.wazokuNavy, borderWidth: 1 }, props.style]}/>;

export const ButtonAlt = props => <Button {...props} style={[{ backgroundColor: 'transparent'}, props.style]}/>;
